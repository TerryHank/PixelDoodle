...
const I18N = {
  zh: {
    ...
    'wifi.device_not_registered': '设备 {uuid} 未注册，请先扫描设备二维码配对',
    ...
    'ble.no_device_hint': '未锁定设备。点击"连接设备"从浏览器蓝牙列表中选择你的 ESP32。',
    ...
    'wifi.select_device_hint': '请在扫码弹窗中扫描设备',
    'wifi.target_locked_scan': '目标设备 {uuid} 已锁定。请在扫码弹窗中执行热点扫描。',
  ...
  en: {
    ...
    'wifi.device_not_registered': 'Device {uuid} not registered, please scan device QR code to pair',
    ...
    'ble.no_device_hint': 'No locked device. Click "Connect Device" and choose your ESP32 from browser Bluetooth list.',
    ...
    'wifi.select_device_hint': 'Scan device in scanner popup',
    'wifi.target_locked_scan': 'Target device {uuid} locked. Scan hotspots in scanner popup.',
