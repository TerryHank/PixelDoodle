...
const I18N = {
  zh: {
    ...
    'ble.saved_device_hint': '已记住设备 {uuid}。点选列表中的设备可重新连接。',
    ...
    'ble.add_device': '添加设备',
    'ble.authorized_device': '已授权',
    'ble.authorized_list_hint': '已授权 {count} 台 BeadCraft 设备，点选即可连接；新设备请点“添加设备”。',
    'ble.no_device_hint': '还没有已授权的 BeadCraft 设备，点“添加设备”进行首次连接。',
    'ble.remembered_device_needs_pair': '已记住 {uuid}，需重新授权',
  ...
  en: {
    ...
    'toast.generating_image': 'Generating image...',
    ...
    'ble.saved_device_hint': 'Device {uuid} is remembered. Tap a device in the list to reconnect.',
    ...
    'ble.add_device': 'Add device',
    'ble.authorized_device': 'Authorized',
    'ble.authorized_list_hint': '{count} authorized BeadCraft devices are ready. Tap one to connect, or add a new device below.',
    'ble.no_device_hint': 'No authorized BeadCraft devices yet. Click "Add device" for the first Bluetooth pairing.',
    'ble.remembered_device_needs_pair': 'Remembered {uuid}, re-authorize required',
