...
- 大小：`98,731,081` 字节
- SHA-256：`dc7a9a9bc886ddd7e3b3beed50c4f8a825263febf3f4d578709e9724a43011db`
...
- v12 的 Tauri Android 已复用 H5 的万相 CloudBase Web SDK 适配器；默认仍为本地像素化，
  只有显式选择万相风格才调用云端。构建前必须配置 `TARO_APP_CLOUDBASE_*`，并完成云函数、
  安全来源和登录规则部署；代码支持不代表上方既有 APK 已完成真实云端与真机验收。详见
