...
describe('pattern service', () => {
  ...
  it('serializes local-only generate options without cloud AI fields', () => {
    ...
    expect(fields.style_transfer).toBeUndefined()
    expect(fields.prompt).toBeUndefined()
    expect(fields.reference_image_url).toBeUndefined()
  })
