/* @ts-self-types="./beadcraft_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function generate_pattern_bytes(bytes, options) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.generate_pattern_bytes(ptr0, len0, options);
    if (ret[2]) {
